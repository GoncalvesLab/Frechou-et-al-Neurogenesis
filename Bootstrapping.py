...
def get_r2(filelist):
    ...
    for filename in filelist:
        ...
        load_file = open(os.path.join(filename, 'rsq_test_bin2'), 'r')
...
def get_tuning(filelist):
    ...
    for filename in filelist:
        ...
        file = scipy.io.loadmat(os.path.join(filename, 'CellTuning_NP.mat'))
...
filelist1 = glob.glob(r"filepath")
filelist2 = glob.glob(r"filepath")
...
group1 = get_r2(filelist1)

# 2) Save second experimental group in variable "group 2".

group2 = get_r2(filelist2)
...
print("r2 p value: ", bootstrap(group1, group2, groupALL))


'''
Amp>50%, R2>50%, Width>50%
'''
